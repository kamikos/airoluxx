...
const navLinks = [
  { name: "PRODUKTE", href: "#produkte", submenu: produkteSubmenu },
  {
    ...
    submenu: einsatzbereicheSubmenu,
  },
...
export function Navigation() {
  ...
  return (
    <nav className="absolute top-0 left-0 w-full z-50 font-roboto-condensed border-t-2 border-[#0EA5E9] bg-white/90 max-h-[76px]">
      <div
          ...
          <div className="hidden lg:flex items-center space-x-2 xl:space-x-6 py-4">
            {navLinks.map((link) => (
              ...
              >
                <Link
                  href={link.href}
                  className={`font-roboto uppercase text-base font-normal spacing px-2 py-2 tracking-wider transition-colors ${
        ...
        >
          {currentSubmenu.map((item) => (
            ...
            >
              ...
              <span className="text-xs text-gray-700 text-center font-medium mb-1">
                Lorem Ipsum
              </span>
            </Link>
          ))}
        ...
        <div className="fixed inset-0 bg-[#0EA5E9] bg-opacity-95 z-50 flex flex-col animate-slideDown">
          ...
          <div className="flex-1 flex flex-col justify-center items-center space-y-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-3xl">
              ...
              <div>
                <div className="uppercase text-white font-bold mb-4 tracking-wider">
                  Produkte
                </div>
          ...
          <div className="flex justify-between items-center px-6 py-4 text-white text-xs opacity-80 border-t border-white/20 mt-auto">
            <div>
              <Link href="#datenschutz" className="hover:underline mr-4">
                DATENSCHUTZ
              </Link>
